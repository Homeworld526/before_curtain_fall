Shader "Custom/UI_PureRaggedBorder"
{
    Properties
    {
        // 这里放入图3（中间黑、边缘白）
        ...
        // 你想要的边框颜色
        _Color ("Border Color", Color) = (0.5, 0.1, 0.1, 1)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                // 输出颜色：RGB直接使用面板设置的_Color，Alpha等于遮罩的R通道（白=1，黑=0）乘以_Color的透明度
                half4 color = half4(_Color.rgb, mask.r * _Color.a);
